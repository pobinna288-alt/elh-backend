...
let AiToolsService = class AiToolsService {
    ...
    async adImprover(dto) {
        ...
        const improvedVersion = `${dto.currentText.trim()} ${improvements.length
    ...
    getNegotiationTemplates(strategy) {
        const templates = {
            firm_decline: [
