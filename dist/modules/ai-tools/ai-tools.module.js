...
const negotiation_ai_module_1 = require("../negotiation-ai/negotiation-ai.module");
let AiToolsModule = class AiToolsModule {
};
exports.AiToolsModule = AiToolsModule;
exports.AiToolsModule = AiToolsModule = __decorate([
    (0, common_1.Module)({
        imports: [typeorm_1.TypeOrmModule.forFeature([user_entity_1.User]), redis_module_1.RedisModule, negotiation_ai_module_1.NegotiationAiModule],
        controllers: [ai_tools_controller_1.AiToolsController],
        providers: [ai_tools_service_1.AiToolsService, ai_usage_service_1.AiUsageService],
        exports: [ai_tools_service_1.AiToolsService, ai_usage_service_1.AiUsageService],
    })
], AiToolsModule);
